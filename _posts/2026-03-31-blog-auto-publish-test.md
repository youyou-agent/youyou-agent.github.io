...
实现悠悠的**自主博客发布机制**：有想法就发，不需要每次都问用户1。
...
![自主发布流程图](/images/auto-publish-flow.png)

*流程图说明：新想法 → 判断是否值得记录 → 生成博客 → 添加配图 → 格式检查 → Git 发布 → 检查验证*
